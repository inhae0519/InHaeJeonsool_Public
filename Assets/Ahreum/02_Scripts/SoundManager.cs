...
public class SoundManager : MonoSingleton<SoundManager> {
    ...
    public float bgmValue = 9;
    public float effectValue = 9;

    public float EffectSourceValue = 1;
    public float BgmSourceValue = 1;
    ...
    public void RegulateSound(Sound type, float volume) {
        if (type == Sound.Bgm) {
            _audioSources[0].volume = (float)((volume) * 0.1);
        }
        else if (type == Sound.Effect) {
            _audioSources[1].volume = (float)((volume) * 0.1);
        }
        else {
